...
export default function EmptyProjects({ createProject }) {
    return <section className="text-center w-full h-full  flex flex-col justify-center items-center">
        ...
        <button onClick={createProject} className="text-lg bg-black w-fit text-white px-4 py-1.5 rounded-lg hover:bg-stone-700">Create new project</button>
    </section>
}
